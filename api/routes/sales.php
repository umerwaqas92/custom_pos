...
function sales_hydrate(PDO $pdo, array $sale, bool $full = true): array
{
    ...
    if ($emiRow) {
        ...
        foreach ($inst->fetchAll() as $i) {
            $installments[] = [
                ...
                'status' => $i['status'],
                'createdAt' => dt_iso($i['created_at']),
                'updatedAt' => dt_iso($i['updated_at']),
            ];
        }
        $emi = [
            'id' => $emiRow['id'],
            ...
            'createdAt' => dt_iso($emiRow['created_at']),
            'updatedAt' => dt_iso($emiRow['updated_at']),
        ];
    }
    ...
    return [
        ...
        'saleDate' => dt_iso($sale['sale_date']),
        ...
        'notes' => $sale['notes'],
        'createdAt' => dt_iso($sale['created_at']),
        'updatedAt' => dt_iso($sale['updated_at']),
        'customer' => $cust,
        'cashier' => $cashier,
        'branch' => $branch,
        'items' => $items,
...
function sales_format_return(PDO $pdo, array $ret, bool $withSale = true): array
{
    ...
    $out = [
        ...
        'returnDate' => dt_iso($ret['return_date']),
        'refundAmount' => (float) $ret['refund_amount'],
        'refundMethod' => $ret['refund_method'],
        'reason' => $ret['reason'],
        'notes' => $ret['notes'],
        'status' => $ret['status'],
        'createdAt' => dt_iso($ret['created_at']),
        'updatedAt' => dt_iso($ret['updated_at']),
        'items' => $items,
